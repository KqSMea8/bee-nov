 ...
 * Created: 2016-7-5
 */
LBF.define('qd/js/book_details/payment.d67e7.js', function (require, exports, module) {
    var
    ...
    exports = module.exports = Node.inherit({
        ...
        clickOnAgreeRules:function(e){
            ...
            if(targetCheckbox.is(':checked')){
                ...
                if(quickBtn.attr('method') != 1){
                    quickBtn.attr('href', '//'+ env +'book.qiyan.com/charge/redirect');
                }
        ...
        changePayTab:function(e){
            ...
            if(payType != 1 && payType != 4 && $(this.agreeRulesCheckbox).is(':checked')){
                ...
                payBtn.attr('href', '//'+ env +'book.qiyan.com/charge/redirect');
            }else{
                payBtn.attr('href','javascript:');
            }
        ...
        exceptionPopup:function(type,otherInfo){
            ...
            var verifyTemplate = new EJS({
                url:'/ejs/qd/js/book_details/exceptionPopup.794ce.ejs'
            }).render({
                sign:signObj,
                data:otherInfo
            });
