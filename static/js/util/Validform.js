    ...
    var Validform = Node.inherit({
        ...
        render: function(forms){
            ...
            $(forms).each(function(){
                ...
                curform.settings.btnSubmit && $curform.find(curform.settings.btnSubmit).bind('click',function(){
                ...
                $curform.find('[type="reset"]').add($curform.find(curform.settings.btnReset)).bind('click',function(){
