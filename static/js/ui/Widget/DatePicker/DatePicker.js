...
LBF.define('ui.widget.DatePicker.DatePicker', function(require){
    ...
    var DatePicker = Dropdown.inherit({
        ...
        mergeOptions: function(opts){
            ...
            // 为了允许trigger内容或value为空，打个标志
            if(this.get('date') === '' || this.get('date') === null){
                // 日期为当天，如果这里不设置，那就是从1970开始算起了，不科学
                this.set('date', new Date());
                this.set('triggerDefaultValue', '');
            }
        ...
        display: function(){
            ...
            if(this.get('triggerDefaultValue') === '' && !this.get('isInit')){
                dateString = '';
            };
...
//                container : '',
            ...
            //Date|String, Selected date. (new Date() || '' || null)
            date : new Date(),
